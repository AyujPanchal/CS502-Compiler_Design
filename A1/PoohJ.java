/* Generated By:JavaCC: Do not edit this line. PoohJ.java */
import syntaxtree.*;
import java.util.Vector;


public class PoohJ implements PoohJConstants {
  ...
  static final public InheritanceDeclaration InheritanceDeclaration() throws ParseException {
   NodeToken n0;
   Token n1;
   Identifier n2;
   NodeToken n3;
   ...
   Token n9;
    n1 = jj_consume_token(CLASS);
                n0 = JTBToolkit.makeNodeToken(n1);
    n2 = Identifier();
    n4 = jj_consume_token(INHERITANCE);
                  n3 = JTBToolkit.makeNodeToken(n4);
    n5 = Identifier();
    ...
    n9 = jj_consume_token(RBRACE);
     ...
     {if (true) return new InheritanceDeclaration(n0,n2,n3,n5,n6,n8);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ArrayLookup ArrayLookup() throws ParseException {
   ...
   Token n8;
    ...
    while (true) {
     ...
     n6.nodes.trimToSize();
     {if (true) return new ArrayLookup(n0,n1,n3,n4,n6);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ForStatement ForStatement() throws ParseException {
   ...
   Token n21;
    ...
    n21 = jj_consume_token(RBRACE);
     ...
     {if (true) return new ForStatement(n0,n2,n4,n5,n7,n8,n10,n11,n13,n14,n16,n18,n20);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MultiplyExpression MultiplyExpression() throws ParseException {
   ...
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(MULTIPLY);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new MultiplyExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public LengthExpression LengthExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   Token n4;
    ...
    n4 = jj_consume_token(LENGTH);
                 n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new LengthExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static public PoohJTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000000,0x0,0x0,0xe0002000,0x0,0x0,0x2000,0xe0000000,0xe0002000,0x20000000,0xe0002000,0xe4002200,0xe4002200,0x0,0x4000000,0x0,0x200,0xe0002000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x40,0x4000b,0x42000,0x200000,0x4000b,0x0,0x2000,0x42000,0x0,0x42000,0x45b820,0x45b820,0x200000,0x11000,0x800,0x400020,0x4a000,0x200000,};
   }
  ...
  public PoohJ(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public PoohJ(java.io.InputStream stream, String encoding) {
    ...
    token_source = new PoohJTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public PoohJ(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public PoohJ(PoohJTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(PoohJTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
