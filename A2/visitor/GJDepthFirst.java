 ...
 */
public class GJDepthFirst implements GJVisitor<String,Map<String, String>> {
   //
   ...
   public String visit(NodeToken n, Map<String,String> argu) { return null; }
   ...
   public String visit(MethodDeclaration n, Map<String,String> argu) {
      ...
      for (Node node : n.f7.nodes) {
        VarDeclaration varDeclNode = (VarDeclaration) node;
        String type;
        String name;
        type = varDeclNode.f0.accept(this, argu);
//         name = varDeclNode.f1.f0.tokenImage;
        name = varDeclNode.f1.accept(this, argu);
        argu.put(name, type);
      }
      n.f8.accept(this, argu);
      n.f9.accept(this, argu);
    ...
    *       | "float" "[" "]"
    */
   public String visit(ArrayType n, Map<String,String> argu) {
      String _ret=null;
      n.f0.accept(this, argu);
      if (n.f0.which == 0) {
        _ret = "int[]";
   ...
   public String visit(AssignmentStatement n, Map<String,String> argu) {
      ...
      if (!typeEquals(idType, exprType, argu)) {
        foundTypeError = true;
      }
      n.f3.accept(this, argu);
      return _ret;
   ...
   public static String getType(String str, Map<String,String> sTable) {
    ...
    * f3 -> "]"
    */
   public String visit(ArrayLookup n, Map<String,String> argu) {
      String _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
    ...
    * f2 -> "length"
    */
   public String visit(ArrayLength n, Map<String,String> argu) {
      String _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
...
//         _ret = n.f0.accept(this, argu);
    ...
    * f4 -> "]"
    */
   public String visit(ArrayAllocationExpression n, Map<String,String> argu) {
      String _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
