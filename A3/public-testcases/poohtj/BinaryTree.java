...
class Tree {
    ...
    public boolean Compare(int num1, int num2) {
        ...
        nti = mtTmp49;
        mtTmp201 = 1;
        mtTmp202 = num2 - mtTmp201;
        mtTmp51 = num1 <= mtTmp202;
        if(mtTmp51) {
            mtTmp52 = false;
            ntb = mtTmp52;
        } else {
            mtTmp203 = 1;
            mtTmp204 = nti - mtTmp203;
            mtTmp54 = num1 <= mtTmp204;
            mtTmp53 = !mtTmp54;
            if(mtTmp53) {
                mtTmp55 = false;
                ntb = mtTmp55;
    ...
    public boolean Insert(int v_key) {
        ...
        while(cont) {
            ...
            key_aux = mtTmp61;
            mtTmp205 = 1;
            mtTmp206 = key_aux - mtTmp205;
            mtTmp62 = v_key <= mtTmp206;
            if(mtTmp62) {
                {
    ...
    public boolean Delete(int v_key) {
        ...
        while(cont) {
            ...
            key_aux = mtTmp81;
            mtTmp207 = 1;
            mtTmp208 = key_aux - mtTmp207;
            mtTmp82 = v_key <= mtTmp208;
            if(mtTmp82) {
                ...
                mtTmp209 = 1;
                mtTmp210 = v_key - mtTmp209;
                mtTmp86 = key_aux <= mtTmp210;
                if(mtTmp86) {
    ...
    public int Search(int v_key) {
        ...
        while(cont) {
            ...
            key_aux = mtTmp142;
            mtTmp211 = 1;
            mtTmp212 = key_aux - mtTmp211;
            mtTmp143 = v_key <= mtTmp212;
            if(mtTmp143) {
                ...
                mtTmp213 = 1;
                mtTmp214 = v_key - mtTmp213;
                mtTmp147 = key_aux <= mtTmp214;
                if(mtTmp147) {
