...
class BS {
    ...
    public boolean Search(int num) {
        ...
        while(var_cont) {
            ...
            aux01 = mtTmp59;
            mtTmp201 = 1;  
            mtTmp202 = aux01 - mtTmp201;
            mtTmp60 = num <= mtTmp202;
            if(mtTmp60) {
                mtTmp62 = 1;
            ...
            mtTmp203 = 1;
            mtTmp204 = left - mtTmp203;
            mtTmp69 = right <= mtTmp204;
            if(mtTmp69) {
                mtTmp70 = false;
                var_cont = mtTmp70;
            } else {
    ...
    public int Div(int num) {
        ...
        aux03 = mtTmp78;
        mtTmp205 = 1;
        mtTmp206 = aux03 - mtTmp205;
        mtTmp80 = count02 <= mtTmp206;
        while(mtTmp80) {
            {
            mtTmp82 = 1;
            ...
            mtTmp207 = 1;
            mtTmp208 = aux03 - mtTmp207;
            mtTmp80 = count02 <= mtTmp208;
        }
        return count01;
    }
    public boolean Compare(int num1, int num2) {
        ...
        aux02 = mtTmp86;
        mtTmp209 = 1;
        mtTmp210 = num2 - mtTmp209;
        mtTmp88 = num1 <= mtTmp210;
        if(mtTmp88) {
            mtTmp89 = false;
            retval = mtTmp89;
        } else {
            mtTmp211 = 1;
            mtTmp212 = aux02 - mtTmp211;
            mtTmp91 = num1 <= mtTmp212;
            mtTmp90 = !mtTmp91;
            if(mtTmp90) {
                mtTmp92 = false;
                retval = mtTmp92;
