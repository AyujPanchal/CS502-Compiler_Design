/* Generated By:JavaCC: Do not edit this line. PoohTJ.java */
import syntaxtree.*;
import java.util.Vector;


public class PoohTJ implements PoohTJConstants {
  ...
  static public PoohTJTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x4400,0x0,0x44001,0x10,0x44001,0x10,0x44001,0x4400,0x20000,0x44001,0x0,0x400,0x4400,0x0,0x7308,0x4000,0x20000,0x7300,0x8,};
   }
  ...
  public PoohTJ(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public PoohTJ(java.io.InputStream stream, String encoding) {
    ...
    token_source = new PoohTJTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public PoohTJ(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public PoohTJ(PoohTJTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(PoohTJTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
